import { X, Cookie, CheckCircle, Pin } from "lucide-react";
import { useTheme } from "@/contexts/ThemeContext";
import step1 from "@/import/step1.png";
import step2 from "@/import/step2.png";
import step3 from "@/import/step3.png";
import step4 from "@/import/step4.png";
import step5 from "@/import/step5.png";
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-3">
              ...
              <div className="ml-11 space-y-3">
                ...
                <img
                  src={step1}
                  alt="Step 1: Chrome Web Store search"
            ...
            <div className="space-y-3">
              ...
              <div className="ml-11 space-y-3">
                ...
                <img
                  src={step2}
                  alt="Step 2: Install Get cookies.txt LOCALLY"
                  className="rounded-lg border border-white/10 w-full max-w-2xl"
                />
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="ml-11 space-y-3">
                ...
                <img
                  src={step4}
                  alt="Step 4: Logged in on YouTube"
                  className="rounded-lg border border-white/10 w-full max-w-2xl"
                />
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="ml-11 space-y-3">
                ...
                <img
                  src={step5}
                  alt="Step 5: Export cookies from the extension"
                  className="rounded-lg border border-white/10 w-full max-w-2xl"
                />
